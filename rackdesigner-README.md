...
1. Run the installer and launch Rack Designer
2. Go to **PROJECT** → **New Project** and fill in the metadata
3. Go to **DESIGNER** → **+ Add Rack** to create your first rack
4. Drag devices from the **LIBRARY** tab onto the rack canvas
5. Go to **EXPORT** to generate a PDF
